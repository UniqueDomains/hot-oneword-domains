# Available .HOT One-Word Domains (28,519)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-28%2C519%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **28,519 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 28,519 domains · **Median ask:** $165.30 · **High-demand under $2,500:** 76
...
| -------- | --------- | --------- | ------------- | -------------- | ------ | ------ | --------- |
| out.hot  | premium   | $3,450    | $3,450        | high           | low    | 3      | namesilo  |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 28,519 live domains                        |
...
> Unique Domains. *Available .HOT One-Word Domains*. Version 2026-09-19. Public GitHub extract for the exact Unique Domains search represented by this repository.
